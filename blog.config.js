...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ixwlcn', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '分享各种知识和技术等', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ixwlcn.dpdns.org/', // 网站地址
